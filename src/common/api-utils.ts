export function successResponse(data: any, meta: any = {}) {
  return {
    success: true,
    data,
    meta: { timestamp: new Date().toISOString(), version: '2.0.0', cacheHit: false, ...meta },
  }
}
...
export function paginatedResponse(data: any, pagination: any, meta: any = {}) {
  return {
    success: true, data,
    meta: { pagination, timestamp: new Date().toISOString(), version: '2.0.0', cacheHit: false, ...meta },
  }
}
...
export function cursorPaginate(array: any[], cursor: string | undefined, limit: number) {
  ...
  return {
    items, total: array.length, limit: l,
    nextCursor, prevCursor,
    hasNextPage: hasNext, hasPrevPage: hasPrev,
